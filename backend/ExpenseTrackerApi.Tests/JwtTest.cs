...
public class JwtTokenGeneratorTests
{
    ...
    public void GenerateJwtToken_ValidUser_ReturnsValidToken()
    {
        ...
        // Validate the generated token using JwtSecurityTokenHandler and TokenValidationParameters
        ...
        // Check that the token was successfully validated (SecurityToken is not null)
