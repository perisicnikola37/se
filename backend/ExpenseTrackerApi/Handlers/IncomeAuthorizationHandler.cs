...
public class IncomeAuthorizationHandler(IHttpContextAccessor httpContextAccessor, DatabaseContext dbContext) : AuthorizationHandler<IncomeAuthorizationRequirement>
{
