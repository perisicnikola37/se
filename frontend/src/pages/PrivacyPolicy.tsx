    ...
    <>
      ...
      >
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Expense tracker.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Expense tracker, accessible
                from{" "}
                <a
                  href="expensetracker.me"
          ...
          <ul>
            <li>
              <p>By email: nikola@e-invoices.online</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="expensetracker.me/help"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  expensetracker.me/help
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +38268077406</p>
            </li>
          </ul>
        </motion.div>
      </motion.div>
